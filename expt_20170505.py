...
expt  = pd.DataFrame(
    ...
    index=pd.MultiIndex.from_product(
        [[validation_partition],range(2,7),range(1,8,2),[0,0.2,0.4],[1],[0.6],[1],[4],[0.1],[50]],
...
expt.to_pickle('xgb_optparam_20170505_' + validation_partition.replace('-','') + '_1st-2.pkl')
feat_rank.to_pickle('xgb_optparam_20170505_' + validation_partition.replace('-','') + '_1st-2_feat_rank.pkl')
...
expt.to_pickle('xgb_optparam_20170504_' + validation_partition.replace('-','') + '_2nd-3.pkl')
feat_rank.to_pickle('xgb_optparam_20170504_' + validation_partition.replace('-','') + '_2nd-3_feat_rank.pkl')
